...
@author: guoyanfeng
@software: PyCharm
@time: 2020/3/2 下午5:45

根据pymongo中的bson中的objectid摘取有用的功能，其他的去掉，这样就不用安装整个pymongo包了
"""
...
from .err import InvalidId

__all__ = ("ObjectId", "objectid")

_MAX_COUNTER_VALUE = 0xFFFFFF


def _bytes_from_hex(h):
